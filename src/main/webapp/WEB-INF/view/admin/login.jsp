...
<head>
    ...
    <link href="${basePath}/resources/common/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/common/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/common/css/login.css" rel="stylesheet"/>
</head>
<body>
<div id="login-window">
...
<script src="${basePath}/resources/common/plugins/checkbix/js/checkbix.min.js"></script>

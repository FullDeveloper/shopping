                ...
                <div class="form-grids widget-shadow" data-example-id="basic-forms">
                    ...
                    <div class="form-body column">
                        <div class="form-group col-lg-3 col-sm-3">
                            ...
                            <input type="text" class="form-control" id="gradeName" name="gradeName" placeholder="等级名称">
                        </div>
                        <div class="form-group col-lg-3 col-sm-3" >
                            <label for="goodsCount">允许发布商品数</label>
                            <input type="text" class="form-control" id="goodsCount"  name="goodsCount" placeholder="允许发布商品数">
                        </div>
                        <div class="form-group col-lg-3 col-sm-3" >
                            <label for="spacesize">店铺附件空间</label>
                            <input type="text" class="form-control" id="spacesize"  name="spacesize" placeholder="店铺附件空间">
                        </div>
                        <div class="form-group col-lg-3 col-sm-3" >
                            <label for="gradeLevel">等级序号</label>
                            <input type="text" class="form-control" id="gradeLevel"  name="gradeLevel" placeholder="越小显示越靠前">
                        </div>
                        <div class="form-group col-lg-3 col-sm-3" >
                            <label for="sequence">等级级别</label>
                            <input type="text" class="form-control" id="sequence"  name="sequence" placeholder="数值越大级别越高，用于店铺升级">
                        </div>
                        <div class="form-group col-lg-3 col-sm-3" >
                            <label for="acountNum">允许子账户个数</label>
                            <input type="text" class="form-control" id="acountNum"  name="acountNum" placeholder="允许卖家添加的子账户个数">
                        </div>
                        <div class="form-group col-lg-3 col-sm-3 column">
                            <label for="audit">是否需要审核</label>
                            <input class="push" id="audit" name="audit" checked type="checkbox"/>
                        ...
                        <div class="form-group col-lg-3 col-sm-3" >
                            ...
                            <input type="text" class="form-control" id="price"  name="price" placeholder="收费标准，在会员开通或升级店铺时将显示在前台">
                        </div>
                        <div class="form-group col-sm-3">
                            <label for="content1">申请说明</label>
                            <textarea name="content" class="form-control" id="content1" cols="30" rows="5"></textarea>
                        </div>
                        <div class="form-group col-lg-3 col-sm-3" >
    ...
    <script>
        function submitInfo() {
            ...
            $.ajax({
                type: 'post',
                data: formData,
                url: '${pageContext.request.contextPath}/store/type/saveTypeInfo',
                processData:false,
                contentType:false,

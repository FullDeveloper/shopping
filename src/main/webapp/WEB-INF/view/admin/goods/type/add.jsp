                    ...
                    <div class="column">
                        ...
                        <div style="display: flex;flex-direction: row;margin-top:8px;">
                            <c:forEach items="${item.goodsBrandList}" var="itemSub" varStatus="status">
                                <div style="width: 25%;">
                                    <label for="">${itemSub.name}</label>
                                    <input type="checkbox" name="brandId" value="${itemSub.id}">
                                </div>
                            </c:forEach>
                        </div>
                    </div>
            ...
            <div class="form-body column">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="addsx_table">
                    ...
                    <tr>
                        ...
                        <td width="558">
                            <input class="display" type="checkbox"  name="display_1" checked/>
                        </td>
                        <td width="558">

    ...
    $(function() {
        ...
        $table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'sort', title: '商品名称', sortable: true, align: 'center'},
                {field: 'name', title: '品牌',align: 'center'},
                {field: 'name', title: '分类名',align: 'center'},
                {field: 'name', title: '所在店铺',align: 'center'},
                {field: 'name', title: '商品状态',align: 'center'},
                {field: 'name', title: '特别推荐',align: 'center'},
                {field: 'name', title: '违规下架',align: 'center'},
                {field: 'name', title: '查看次数',align: 'center'},

...
<head>
    ...
    <link href="${basePath}/resources/common/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/common/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/common/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/common/css/admin.css" rel="stylesheet"/>
</head>
<style>
    /** skins **/

    #distributed-upms-server #header {background: #29A176;}
    #distributed-upms-server .content_tab{background: #29A176;}
    #distributed-upms-server .s-profile>a{background: url("/resources/common/images/zheng-upms.png") left top no-repeat;}
</style>
<body>
<header id="header">
    <ul id="menu">
        ...
        <li id="logo" class="hidden-xs">
            <a href="${basePath}/manage/index">
                <img src="${basePath}/resources/common/images/logo.png"/>
            </a>
    ...
    <aside id="sidebar">
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu system_menus system_1">
                ...
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('卖家信用', '/store/credit/index');">卖家信用</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('店铺管理', '/store/manager/index');">店铺管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('店铺模板', '/store/brand/index');">店铺模板</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('店铺类型', '/store/type/index');">店铺类型</a></li>
...
<script src="${basePath}/resources/common/plugins/device.min.js"></script>
<script src="${basePath}/resources/common/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/common/js/admin.js"></script>
<script src="${basePath}/resources/common/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/common/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>

        ...
        <div class="pageright" id="site-nav">
            <ul class="quick-menu">
                <li class="mytaobao menu-item menupx">
                    <div class="menu"><a class="menu-hd" href="${basePath}/buyer/index.htm"
                        ...
                        <div class="menu-bd">
                            <div class="menu-bd-panel">
                                <div>
                                    ...
                                    <a href="${basePath}/buyer/order.htm?order_status=order_submit"
                                       rel="nofollow">待支付</a>
                                    <a href="${basePath}/buyer/order.htm?order_status=order_shipping"
                                       rel="nofollow">待收货</a>
                                    <a href="${basePath}/buyer/order.htm?order_status=order_receive"
                                       rel="nofollow">待评价</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="menu-bd" id="cart_goods_top_info">
                            <div class="menu-bd-panel">
                                <div style="text-align:center;"><img
                                        src="${basePath}/resources/style/common/images/loader.gif"/></div>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="mytaobao menu-item menupx">
                    <div class="menu"><a class="menu-hd" href="${basePath}/buyer/favorite_goods.htm"
                ...
                <shiro:hasPermission name="shop:admin:manager">
        ...
        <div class="pageleft">
            <c:choose>
                <c:when test="${user != null}">
                    ...
                    <a href="$!webPath/shopping_logout.htm" class="lightblue">[退出]</a>
                </c:when>
                <c:otherwise>
                    <span class="pxlr">
